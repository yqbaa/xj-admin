...
<head>
    ...
    <!-- Bootstrap -->
    <link href="http://assets.xj.com/admin/css/vendor/bootstrap/bootstrap.min.css" rel="stylesheet">
    <link href="http://netdna.bootstrapcdn.com/font-awesome/4.0.3/css/font-awesome.css" rel="stylesheet">
    <link rel="stylesheet" href="http://assets.xj.com/admin/css/vendor/animate/animate.min.css">
    <link type="text/css" rel="stylesheet" media="all" href="http://assets.xj.com/admin/js/vendor/mmenu/css/jquery.mmenu.all.css" />
    <link rel="stylesheet" href="http://assets.xj.com/admin/js/vendor/videobackground/css/jquery.videobackground.css">
    <link rel="stylesheet" href="http://assets.xj.com/admin/css/vendor/bootstrap-checkbox.css">

    <link rel="stylesheet" href="http://assets.xj.com/admin/js/vendor/rickshaw/css/rickshaw.min.css">
    <link rel="stylesheet" href="http://assets.xj.com/admin/js/vendor/morris/css/morris.css">
    <link rel="stylesheet" href="http://assets.xj.com/admin/js/vendor/tabdrop/css/tabdrop.css">
    <link rel="stylesheet" href="http://assets.xj.com/admin/js/vendor/summernote/css/summernote.css">
    <link rel="stylesheet" href="http://assets.xj.com/admin/js/vendor/summernote/css/summernote-bs3.css">
    <link rel="stylesheet" href="http://assets.xj.com/admin/js/vendor/chosen/css/chosen.min.css">
    <link rel="stylesheet" href="http://assets.xj.com/admin/js/vendor/chosen/css/chosen-bootstrap.css">

    <link href="http://assets.xj.com/admin/css/minimal.css" rel="stylesheet">
                    ...
                    <li class="dropdown divided">
                        ...
                        <ul class="dropdown-menu wider arrow nopadding messages">
                            ...
                            <li>
                                <a class="cyan" href="#">
                                    <div class="profile-photo">
                                        <img src="http://assets.xj.com/admin/images/ici-avatar.jpg" alt />
                                    </div>
                            ...
                            <li>
                                <a class="green" href="#">
                                    <div class="profile-photo">
                                        <img src="http://assets.xj.com/admin/images/arnold-avatar.jpg" alt />
                                    </div>
                                    <div class="message-info">
                            ...
                            <li>
                                <a href="#">
                                    <div class="profile-photo">
                                        <img src="http://assets.xj.com/admin/images/profile-photo.jpg" alt />
                                    </div>
                                    <div class="message-info">
                            ...
                            <li>
                                <a class="red" href="#">
                                    <div class="profile-photo">
                                        <img src="http://assets.xj.com/admin/images/peter-avatar.jpg" alt />
                                    </div>
                                    <div class="message-info">
                            ...
                            <li>
                                <a class="orange" href="#">
                                    <div class="profile-photo">
                                        <img src="http://assets.xj.com/admin/images/george-avatar.jpg" alt />
                                    </div>
                                    <div class="message-info">
                        ...
                        <section class="tile transparent recent-activity">
                            ...
                            <div class="tile-body tab-content nopadding rounded-bottom-corners">
                                ...
                                <ul id="users-tab" class="tab-pane fade in active">
                                    <li>
                                        <img src="http://assets.xj.com/admin/images/peter-avatar.jpg" class="w35" alt>
                                    ...
                                    <li>
                                        <img src="http://assets.xj.com/admin/images/arnold-avatar.jpg" class="w35" alt>
                                    ...
                                    <li>
                                        <img src="http://assets.xj.com/admin/images/ici-avatar.jpg" class="w35" alt>
                                ...
                                <ul id="orders-tab" class="tab-pane fade">
                                    ...
                                    <li>
                                        <img src="http://assets.xj.com/admin/images/george-avatar.jpg" class="w35" alt>
                                ...
                                <ul id="messages-tab" class="tab-pane fade">
                                    <li>
                                        <img src="http://assets.xj.com/admin/images/profile-photo.jpg" class="w35" alt>
                ...
                <div class="tab-pane active" id="mmenu-users">
                    ...
                    <ul class="users-list">
                        ...
                        <li class="online">
                            <div class="media">
                                <a class="pull-left profile-photo" href="#">
                                    <img class="media-object" src="http://assets.xj.com/admin/images/ici-avatar.jpg" alt>
                                </a>
                                <div class="media-body">
                        ...
                        <li class="online">
                            <div class="media">
                                ...
                                <a class="pull-left profile-photo" href="#">
                                    <img class="media-object" src="http://assets.xj.com/admin/images/arnold-avatar.jpg" alt>
                                </a>
                        ...
                        <li class="online">
                            <div class="media">
                                <a class="pull-left profile-photo" href="#">
                                    <img class="media-object" src="http://assets.xj.com/admin/images/peter-avatar.jpg" alt>
                        ...
                        <li class="online">
                            <div class="media">
                                <a class="pull-left profile-photo" href="#">
                                    <img class="media-object" src="http://assets.xj.com/admin/images/george-avatar.jpg" alt>
                                </a>
                                <div class="media-body">
                        ...
                        <li class="busy">
                            <div class="media">
                                <a class="pull-left profile-photo" href="#">
                                    <img class="media-object" src="http://assets.xj.com/admin/images/random-avatar1.jpg" alt>
                                </a>
                                <div class="media-body">
                        ...
                        <li class="busy">
                            <div class="media">
                                <a class="pull-left profile-photo" href="#">
                                    <img class="media-object" src="http://assets.xj.com/admin/images/random-avatar2.jpg" alt>
                                </a>
                                <div class="media-body">
                    ...
                    <ul class="users-list">
                        ...
                        <li class="offline">
                            <div class="media">
                                <a class="pull-left profile-photo" href="#">
                                    <img class="media-object" src="http://assets.xj.com/admin/images/random-avatar4.jpg" alt>
                                </a>
                                <div class="media-body">
                        ...
                        <li class="offline">
                            <div class="media">
                                ...
                                <a class="pull-left profile-photo" href="#">
                                    <img class="media-object" src="http://assets.xj.com/admin/images/random-avatar5.jpg" alt>
                                </a>
                        ...
                        <li class="offline">
                            <div class="media">
                                <a class="pull-left profile-photo" href="#">
                                    <img class="media-object" src="http://assets.xj.com/admin/images/random-avatar6.jpg" alt>
                        ...
                        <li class="offline">
                            <div class="media">
                                <a class="pull-left profile-photo" href="#">
                                    <img class="media-object" src="http://assets.xj.com/admin/images/random-avatar7.jpg" alt>
                                </a>
                                <div class="media-body">
                        ...
                        <li class="offline">
                            <div class="media">
                                <a class="pull-left profile-photo" href="#">
                                    <img class="media-object" src="http://assets.xj.com/admin/images/random-avatar8.jpg" alt>
                                </a>
                                <div class="media-body">
...
<script src="http://assets.xj.com/admin/js/jquery.js"></script>
<!-- Include all compiled plugins (below), or include individual files as needed -->
<script src="http://assets.xj.com/admin/js/vendor/bootstrap/bootstrap.min.js"></script>
<script type="text/javascript" src="http://assets.xj.com/admin/js/vendor/mmenu/js/jquery.mmenu.min.js"></script>
<script type="text/javascript" src="http://assets.xj.com/admin/js/vendor/sparkline/jquery.sparkline.min.js"></script>
<script type="text/javascript" src="http://assets.xj.com/admin/js/vendor/nicescroll/jquery.nicescroll.min.js"></script>
<script type="text/javascript" src="http://assets.xj.com/admin/js/vendor/animate-numbers/jquery.animateNumbers.js"></script>
<script type="text/javascript" src="http://assets.xj.com/admin/js/vendor/videobackground/jquery.videobackground.js"></script>
<script type="text/javascript" src="http://assets.xj.com/admin/js/vendor/blockui/jquery.blockUI.js"></script>

<script src="http://assets.xj.com/admin/js/vendor/flot/jquery.flot.min.js"></script>
<script src="http://assets.xj.com/admin/js/vendor/flot/jquery.flot.time.min.js"></script>
<script src="http://assets.xj.com/admin/js/vendor/flot/jquery.flot.selection.min.js"></script>
<script src="http://assets.xj.com/admin/js/vendor/flot/jquery.flot.animator.min.js"></script>
<script src="http://assets.xj.com/admin/js/vendor/flot/jquery.flot.orderBars.js"></script>
<script src="http://assets.xj.com/admin/js/vendor/easypiechart/jquery.easypiechart.min.js"></script>

<script src="http://assets.xj.com/admin/js/vendor/rickshaw/raphael-min.js"></script>
<script src="http://assets.xj.com/admin/js/vendor/rickshaw/d3.v2.js"></script>
<script src="http://assets.xj.com/admin/js/vendor/rickshaw/rickshaw.min.js"></script>

<script src="http://assets.xj.com/admin/js/vendor/morris/morris.min.js"></script>

<script src="http://assets.xj.com/admin/js/vendor/tabdrop/bootstrap-tabdrop.min.js"></script>

<script src="http://assets.xj.com/admin/js/vendor/summernote/summernote.min.js"></script>

<script src="http://assets.xj.com/admin/js/vendor/chosen/chosen.jquery.min.js"></script>

<script src="http://assets.xj.com/admin/js/minimal.min.js"></script>
